...
+# Beer and Fries - The Ultimate Combination!
 ...
 +
 +__If you are using 3rd party libraries, don't forget to include `package.json` as well.
 */

 var beerAndFries = function beerAndFries(items){
    if(items.length === 0){
      return 0;
    }
    var beer = items.filter(function(value){
      return value.type === "beer";
    });
